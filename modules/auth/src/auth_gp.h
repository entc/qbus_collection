...
__CAPE_LIBEX   AuthGP   auth_gp_new           (AdblSession adbl_session, AuthVault, number_t wpid);
...
__CAPE_LIBEX   int      auth_wp_info_get      (AuthGP*, QBusM qin, QBusM qout, CapeErr err);

__CAPE_LIBEX   int      auth_wp_default_get   (AuthGP*, QBusM qin, QBusM qout, CapeErr err);

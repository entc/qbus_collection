...
int main (int argc, char *argv[])
{
  ...
  CapeString path_current = cape_fs_path_current (NULL);
  ...
  CapeString path_link_rel = cape_fs_path_current ("TestFolderLinkRel");
  CapeString path_link_abs = cape_fs_path_current ("TestFolderLinkAbs");
  ...
  res = cape_fs_path_ln ("TestFolder", "TestFolderLnRel", path_current, err);
  if (res)
  {
    goto exit_and_cleanup;
  }
  ...
  res = cape_fs_path_ln (path_test_folder, "TestFolderLnAbs", NULL, err);
  if (res)
  {
    goto exit_and_cleanup;
  }
  ...
  // test absolute symlink
  res = cape_fs_path_ln ("TestFolder", path_link_rel, path_current, err);
  if (res)
  {
    goto exit_and_cleanup;
  }
  ...
  // test absolute symlink
  res = cape_fs_path_ln (path_test_folder, path_link_abs, NULL, err);
  if (res)
  {
    goto exit_and_cleanup;
  }
...
exit_and_cleanup:
  ...
  cape_str_del (&path_link_abs);
  cape_str_del (&path_link_rel);

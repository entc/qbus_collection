...
__CAPE_LIBEX   QBus               qbus_new               (const CapeString module, CapeUdc* p_args);

__CAPE_LIBEX   void               qbus_del               (QBus*);

                                  /* runs qbus in the same thread in blocking mode */
__CAPE_LIBEX     int              qbus_run               (QBus, CapeErr err);
...
__CAPE_LIBEX   int                qbus_init              (QBus, CapeErr err);

__CAPE_LIBEX   int                qbus_wait              (QBus, CapeErr err);
